class AgentStatusIndicator < Formula
  ...
  version "0.2.24-alpha.1"
  license "Apache-2.0"
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/DuRunzhe/AgentIndicator/releases/download/v0.2.24-alpha.1/agent-status-indicator-aarch64-apple-darwin.tar.gz"
      sha256 "REPLACE_ON_RELEASE"
    else
      url "https://github.com/DuRunzhe/AgentIndicator/releases/download/v0.2.24-alpha.1/agent-status-indicator-x86_64-apple-darwin.tar.gz"
      sha256 "REPLACE_ON_RELEASE"
    end
  end
  def install
