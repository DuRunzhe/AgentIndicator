...
The current release is **v0.2.10** (macOS arm64, Developer ID signed and notarized). x86_64 macOS / Windows / Linux artifacts are produced automatically for later versions by the [release workflow](.github/workflows/release.yml).
...
# pin a version: VERSION=0.2.10 curl -fsSL ... | sh
