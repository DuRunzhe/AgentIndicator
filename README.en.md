...
The current release is **v0.2.11** (macOS arm64, Developer ID signed and notarized). x86_64 macOS / Windows / Linux artifacts are produced automatically for later versions by the [release workflow](.github/workflows/release.yml).
...
# pin a version: VERSION=0.2.11 curl -fsSL ... | sh
